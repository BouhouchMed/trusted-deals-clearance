  ...
  return (
    <section className="simple-page">
      ...
      <p>
        ...
        measure visits, page activity, and marketing campaign performance. Meta Pixel and analytics cookies are enabled
        by default, and you can turn them off at any time from Cookie Preferences.
      </p>
